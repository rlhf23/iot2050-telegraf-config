...
pub fn format_config_header(
    ...
    let use_dual_bucket = include_test_inputs || include_diagnostics;
...
"#
    ...
    let diagnostics_inputs = if include_diagnostics {
        let mut diag_config =
            r#"#=================================================================================
#      🔧 DIAGNOSTICS INPUTS START - OPC UA SERVER MONITORING
#=================================================================================
...
[[inputs.opcua]]
  ...
  [[inputs.opcua.group]]
    ...
    identifier_type = "i"
    nodes = [
      {{name="server_state", identifier="2259"}},
      {{name="current_sessions", identifier="2277"}},
      {{name="current_subscriptions", identifier="2285"}},
      {{name="cumulated_sessions", identifier="2278"}},
      {{name="cumulated_subscriptions", identifier="2286"}},
      {{name="publishing_interval_count", identifier="2284"}},
      {{name="rejected_requests", identifier="2288"}},
      {{name="rejected_sessions", identifier="3705"}},
      {{name="session_abort_count", identifier="2282"}},
      {{name="session_timeout_count", identifier="2281"}}
    ]
